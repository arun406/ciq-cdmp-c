...
@Component
@Slf4j
@EventHandler(eventType = Constants.PLAN_EVENT, eventCode = Constants.PLAN_CREATED, version = com.aktimetrix.core.api.Constants.DEFAULT_VERSION)
public class ProcessPlanCreatedEventHandler implements com.aktimetrix.core.api.EventHandler {
