...
@Component
@Slf4j
@EventHandler(eventType = Constants.PLAN_EVENT, eventCode = Constants.PLAN_UPDATED, version = Constants.DEFAULT_VERSION)
public class ProcessPlanUpdatedEventHandler implements com.aktimetrix.core.api.EventHandler {
