package com.aktimetrix.service.processor.ciq.cdmpc.event.exception;
...
public class StepNotFoundException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected StepNotFoundException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
